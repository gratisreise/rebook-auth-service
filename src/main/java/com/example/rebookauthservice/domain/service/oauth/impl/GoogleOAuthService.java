...
import com.example.rebookauthservice.external.oauth.google.GoogleApiClient;
import com.example.rebookauthservice.external.oauth.google.GoogleTokenResponse;
import com.example.rebookauthservice.external.oauth.google.GoogleUserInfoResponse;
...
public class GoogleOAuthService implements OAuthService {
  ...
  public TokenResponse authenticate(OAuthRequest request) {
    ...
    UsersCreateRequest req = UsersCreateRequest.of(
        OauthProvider.GOOGLE.getEmail(),  userInfo.getNickname());
